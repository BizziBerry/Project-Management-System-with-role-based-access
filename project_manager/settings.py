...
import sys  # Добавляем этот импорт!
...
SECRET_KEY = 'django-insecure-7v-sr7--moeg91gg0&kv6i4t%50z=t*v#+*%nlnphv8jvkf0je'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Разрешенные хосты для разработки и тестирования
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1', 
    'testserver',  # Добавляем для тестирования
]
...
STATIC_ROOT = BASE_DIR / 'static_root'  # Изменяем на static_root
